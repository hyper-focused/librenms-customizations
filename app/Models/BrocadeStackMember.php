...
/**
 * BrocadeStackMember Model
 *
 * Represents individual stack members in a Brocade/Ruckus stack
 ...
 */
class BrocadeStackMember extends Model
{
    protected $table = 'brocade_stack_members';
    ...
    {
        return $this->belongsTo(BrocadeStackTopology::class, 'device_id', 'device_id');
    }
