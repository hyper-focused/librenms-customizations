...
snmpget -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.3.31.1.2.0

# Get stack MAC address
snmpget -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.3.31.1.1.0
```

### 2. Stack Members (Critical)
```bash
# Get all stack member information
snmpwalk -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.3.31.3.1
```
...
snmpwalk -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.1.4.1.1.2
```

### 4. Additional System Info
```bash
# Software version
snmpget -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.2.1.1.0

# Boot version
snmpget -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991.1.1.2.1.2.0
```
...
## 🔧 Alternative: Complete SNMP Walk

If you prefer, you can just do a complete walk of the Foundry enterprise OID:

```bash
# Complete walk (will take a minute or two)
snmpwalk -v2c -c public YOUR_SWITCH_IP .1.3.6.1.4.1.1991 > fcx648_complete_walk.txt
snmpwalk -v2c -c public YOUR_ICX_IP .1.3.6.1.4.1.1991 > icx6450_complete_walk.txt
```
...
```bash
snmpget -v2c -c public SWITCH_IP .1.3.6.1.2.1.1.1.0 .1.3.6.1.2.1.1.2.0
```
