...
$sensors = \App\Models\Sensor::where('sensor_class', $class)->where('device_id', $device['device_id'])
    ->when(! empty($sensor_exclude_types), fn ($q) => $q->whereNotIn('sensor_type', $sensor_exclude_types))
    ->orderBy('sensor_descr')->get();
